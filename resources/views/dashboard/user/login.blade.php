    ...
    <div class="row justify-content-center my-5 form-signup">
        <form action="{{ route('user.login') }}" method="post" class="col-md-6 bg-light p-3" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="email" id="email" class="form-control" placeholder="1234@gmail.com" value="{{ Session::get('verifiedEmail') ? Session::get('verifiedEmail') : old('email') }}">
            ...
            <input type="checkbox" name="remember" id="remember" value="1"> Ghi nhớ tài khoản?
